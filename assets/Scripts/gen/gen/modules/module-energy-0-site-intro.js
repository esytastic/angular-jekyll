...
gogoroApp.controller('moduleEnergy0SiteIntroController', ["$scope", "$element", "FallbackManagerFactory", "$rootScope", function ($scope, $element, FallbackManagerFactory, $rootScope) {
        ...
        $scope.standard = {
            ...
            destroy: function() {
                $('.module-energy-0-site-intro').unbind('mousewheel DOMMouseScroll MozMousePixelScroll');
                $('.module-energy-0-site-intro').css({
                    display: 'none'
                });
            }
        };
