...
gogoroApp.controller('moduleBethenext1IntroController', ["$scope", "$element", "$interval", "FallbackManagerFactory", "$rootScope", function ($scope, $element, $interval, FallbackManagerFactory, $rootScope) {
	...
	$scope.standard = {
	  ...
	  $scope.fallback = {
	    init: function() {
	    	var $bodyEl = $el.find('.body').css('bottom', '160px');
	    },
	    destroy: function() {
	    }
	  };
