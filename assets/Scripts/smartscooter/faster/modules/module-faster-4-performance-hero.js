...
gogoroApp.controller('moduleFaster4PerformanceHeroController', ["$scope", "$element", "$controller", "FallbackManagerFactory", function ($scope, $element, $controller, FallbackManagerFactory) {
	angular.extend($scope, FallbackManagerFactory);

	$scope.standard = {
      init: function() {
        /*
        $.extend(this, $controller('ModuleTestController', {
          $scope: $scope,
          $element: $element
        }));
        */
