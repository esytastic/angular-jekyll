...
(function ($, global) {
    ...
    Header.prototype.mouseScrollingWithCollisiontTabbar = function () {
        ...
        $(window).on('scroll.tabbar', function () {
            ...
            self.$mainHeader.css("backgroundColor", "rgba(255,255,255," + st / (introH-200) + ")").css('borderBottom', "rgba(241,243,243," + st / introH + ")");
    ...
    Header.prototype.mouseScrollingWithoutCollisionElement = function () {
        ...
        $(window).on('scroll.headerscrolling', function () {
            ...
            var st = $(window).scrollTop();
            if ($(".GoStaion_AllYou").length > 0 && st > 1350 && st < 1800)
            {
                var opt = (st - 1446) / 200;
                $(".GoStaion_AllYou").css("opacity", 1-opt);
                $(".GoStaion_AllYou2").css("opacity", opt);
            };
